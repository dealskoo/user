...
<script type="text/javascript">
    let language = {
        ...
        "lengthMenu": "{{ __('admin::user.display') }} <select class='form-select form-select-sm ms-1 me-1'><option value='10'>10</option><option value='20'>20</option></select> {{ __('user::user.entries') }}",
    };
    let pageLength = 10;
</script>
@yield('script')
