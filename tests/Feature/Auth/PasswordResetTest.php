...
class PasswordResetTest extends TestCase
{
    ...
    {
        $response = $this->get(route('user.password.request', [config('country.prefix') => request()->country()->alpha2]));
    ...
    public function test_reset_password_link_can_be_requested()
    {
        ...
        $this->post(route('user.password.email', [config('country.prefix') => request()->country()->alpha2]), ['email' => $user->email]);
    ...
    public function test_reset_password_screen_can_be_rendered()
    {
        ...
        Notification::assertSentTo($user, ResetUserPassword::class, function ($notification) {
            $response = $this->get(route('user.password.reset', [config('country.prefix') => request()->country()->alpha2, 'token' => $notification->token]));
    ...
    public function test_password_can_be_reset_with_valid_token()
    {
        ...
        Notification::assertSentTo($user, ResetUserPassword::class, function ($notification) use ($user) {
            $response = $this->post(route('user.password.update', [config('country.prefix') => request()->country()->alpha2]), [
