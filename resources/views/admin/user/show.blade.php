...
@section('title',__('user::user.user_information'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('user::user.user_information') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('user::user.user_information') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
